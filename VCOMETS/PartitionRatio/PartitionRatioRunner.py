...
#Maximum Uptake Rate
#1 means that the uptake rate is default, there are no special bounds
uptakes = [1]
...
for staticMetabolites in [True, False]:
        ...
        for glcConc in glcConcentrations: 
            for vmin in thresholds:
                ...
                if (not staticMetabolites):
                    output = open("ResourcePartition|uptake=" + str(uptake) + "|vmin=" + str(vmin) + "|Glc=" + str(glcConc) + ".csv", "w")
                else:
                    output = open("ResourcePartition|static|uptake=" + str(uptake) + "|vmin=" + str(vmin) + "|Glc=" + str(glcConc) + ".csv", "w")
                ...
                for r in partitions:
                    ...
                    if (not staticMetabolites):
                        ...
                        #test_tube.set_specific_metabolite('ocdcea_e', 1000)# Not in DMEM media
